    ...
    <div class="p-4 bg-white rounded-lg shadow-md">
        ...
        <form action="{{ route('products.update', $product) }}" method="POST">
                ...
                <div class="w-1/2 mr-2 w-full">
                    <div class="mt-4">
                        ...
                        <x-text-input type="number"
                                ...
                                value="{{ old('year_start', $product->year_start) }}"
                                step="1"
                                />
                ...
                <div class="w-1/2 ml-2 w-full">
                    <div class="mt-4">
                        ...
                        <x-text-input type="number"
                                ...
                                value="{{ old('year_end', $product->year_end) }}"
                                step="1"
                                />
            ...
            <div class="mt-4">
                ...
                <x-select name="transmission" id="transmission" class="block w-full {{ $errors->has('transmission') ? 'border-red-500' : '' }}">
                    @foreach (App\Enums\Products\TransmissionEnum::cases() as $transmission)
                        <option value="{{ $transmission->value }}" 
                            @selected(old('transmission') 
                                ? old('transmission') == $transmission->value 
                                : $product->transmission == $transmission->value)
                                >{{ $transmission->value }}</option>
                    @endforeach
                </x-select>
            ...
            <div class="flex">
                <div class="w-1/2 mr-2 w-full">
                    <div class="mt-4">
                        ...
                        <x-text-input type="text"
                                ...
                                value="{{ old('thickness_number', $product->thickness_number) }}"
                                />
                ...
                <div class="w-1/2 ml-2 w-full">
                    <div class="mt-4">
                        ...
                        <x-select name="thickness" id="thickness" class="block w-full {{ $errors->has('thickness') ? 'border-red-500' : '' }}">
                            @foreach (App\Enums\Products\ThicknessEnum::cases() as $thickness)
                                <option value="{{ $thickness->value }}" 
                                    @selected(old('thickness') 
                                        ? old('thickness') == $thickness->value 
                                        : $product->thickness == $thickness->value)
                                        >{{ $thickness->value }}</option>
                            @endforeach
                        </x-select>
            ...
            <div class="mt-4">
                ...
                <x-text-input type="text"
                         ...
                         value="{{ old('stock_number', $product->stock_number) }}"
                         />
            ...
            <div class="mt-4">
                ...
                <x-text-input type="number"
                         ...
                         step="any"
                         value="{{ old('enterex_price', $product->enterex_price) }}"
                         />
            ...
            <div class="mt-4">
                ...
                <x-textarea id="notes" name="notes" class="block w-full {{ $errors->has('notes') ? 'border-red-500' : '' }}">{{ old('notes', $product->notes) }}</x-textarea>
